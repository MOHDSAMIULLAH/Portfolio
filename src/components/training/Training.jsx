  ...
  return (
    <section id='Training'>
      ...
      <div className="container trainings__container">
          ...
          <div className="training">
          <div className="client__avatar">
               <img src={pentagonspace} alt="" />
              </div>
              <h5 className="client__name"> Pentagon  Space | JAVA Full Stack Web  Development </h5>
                <small className="client__review">
                <ul className='training__list'>
                    <li>
                    <FaHandPointRight className='training__list-icon' />
                    <p>Java Full-stack Web Development Training for 4 months </p>
                    </li>
                    <li>
                    <FaHandPointRight className='training__list-icon' />
                    <p>Data Structure and Algorithms and problem-solving skills</p>
                    ...
                    <li>
                    <FaHandPointRight className='training__list-icon' />
                    <p>Technical Stack- JAVA, Hibernate, Spring, SQL, DBMS</p>
                    </li>
                    <li>
                    <FaHandPointRight className='training__list-icon' />
                    <p>Working and getting hands-on experience in real-time projects</p>
